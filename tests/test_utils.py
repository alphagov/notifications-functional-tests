...
def create_an_email_template_and_add_attach_a_file(driver, file_name, template_name, content):
...
def delete_file_from_email_template_via_manage_files_page(driver):
    manage_file_page = ManageEmailTemplateFilePage(driver)
    manage_file_page.click_remove_file_link()
    manage_file_page.click_remove_file_dialog_button()
