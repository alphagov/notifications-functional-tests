...
from tests.pages import (
    ...
    YouHaveAFileToDownloadPage, ChangeRentionPeriodForEmailFilePage,
...
@recordtime
def test_add_test_document_download_via_ui_file_management_settings(driver, login_seeded_user):
