...
class Config(object):
    ...
    NOTIFY_RESEARCH_SMS_SENDER = os.environ.get(os.environ.get('ENVIRONMENT') + '_NOTIFY_RESEARCH_SMS_SENDER')
...
class PreviewConfig(Config):
    ...
    NOTIFY_RESEARCH_SMS_SENDER = os.environ.get('preview_NOTIFY_RESEARCH_SMS_SENDER')
